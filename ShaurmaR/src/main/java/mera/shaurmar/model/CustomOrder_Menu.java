...
public class CustomOrder_Menu implements Serializable{
    ...
    private List<CustomOrderMenu_Ingredient> additivs  = new ArrayList<>();
    ...
    public boolean equals(Object obj) {
        ...
        final CustomOrder_Menu other = (CustomOrder_Menu) obj;
    ...
    public String toString() {
        return "CustomOrder_Menu{" + "id=" + id  + ", count=" + count + ", shaurmaSize=" + shaurmaSize + ", additivs=" + additivs +", cusorder=" + cusorder + ", menu=" + menuItem + '}';
    }
    ...
    public List<CustomOrderMenu_Ingredient> getAdditivs() {
        return additivs;
    }

    public void setAdditivs(List<CustomOrderMenu_Ingredient> additivs) {
